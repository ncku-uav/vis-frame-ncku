...
uint32_t FrSkySportSensorRpm::getRpm() { data_available = 0; return rpm; }
int32_t FrSkySportSensorRpm::getT1() { data_available = 0; return t1; }
int32_t FrSkySportSensorRpm::getT2() { data_available = 0; return t2; }
