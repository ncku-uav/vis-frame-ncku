...
float volt1,volt2,curr;

void setup()
{
  decoder.begin(FrSkySportSingleWireSerial::SOFT_SERIAL_PIN_2, &flvss1, &flvss2, &fcs);
...
void loop()
{
  ...
  volt1=flvss1.getCell1();  // Read cell 1 voltage from the standard FLVSS sensor and do something with it
