...
float FrSkySportSensorGps::getLat() { data_available = 0; return lat; }
float FrSkySportSensorGps::getLon() { data_available = 0; return lon; }
float FrSkySportSensorGps::getAltitude() { data_available = 0; return altitude; }
float FrSkySportSensorGps::getSpeed() { data_available = 0; return speed; }
float FrSkySportSensorGps::getCog() { data_available = 0; return cog; }
uint16_t FrSkySportSensorGps::getYear() { data_available = 0; return year+2000; }
uint8_t FrSkySportSensorGps::getMonth() { data_available = 0; return month; }
uint8_t FrSkySportSensorGps::getDay() { data_available = 0; return day; }
uint8_t FrSkySportSensorGps::getHour() { data_available = 0; return hour; }
uint8_t FrSkySportSensorGps::getMinute() { data_available = 0; return minute; }
uint8_t FrSkySportSensorGps::getSecond() { data_available = 0; return second; }
