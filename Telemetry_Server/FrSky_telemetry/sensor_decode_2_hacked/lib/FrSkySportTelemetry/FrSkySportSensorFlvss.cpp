...
float FrSkySportSensorFlvss::getCell1() { data_available = 0; return cell[0]; }
float FrSkySportSensorFlvss::getCell2() { data_available = 0; return cell[1]; }
float FrSkySportSensorFlvss::getCell3() { data_available = 0; return cell[2]; }
float FrSkySportSensorFlvss::getCell4() { data_available = 0; return cell[3]; }
float FrSkySportSensorFlvss::getCell5() { data_available = 0; return cell[4]; }
float FrSkySportSensorFlvss::getCell6() { data_available = 0; return cell[5]; }
