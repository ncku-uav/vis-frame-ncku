# Data provider for the Aircraft_ABC implementation
...
def sendToMCT(run):
    ...
    UDP_PORT_SEND =14570   #chosen port to OpenMCT (same as in telemetry server object)
...
def command(run):
    ...
    UDP_PORT_RCV =14571    #chosen port to OpenMCT (same as in telemetry server object)
    data = ''
    addr = ''
    connected = False
