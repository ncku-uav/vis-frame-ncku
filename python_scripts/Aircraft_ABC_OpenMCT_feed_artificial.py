# Artificial Data provider for the Aircraft_ABC implementation
...
UDP_PORT =14570   #chosen port to OpenMCT (same as in telemetry server object)
MESSAGE = "23,567,32,4356,456,132,4353467" #init message

data = 0 #artificial data

keys = [
    # those are the keys for the Aircraft_ABC, which are declared in the dictionary on OpenMCT side
